...
let handleMembeLeft = async (MemberId) => {
...
let handleChannelMessage = async (messageData, MemberId) => {
    ...
    if (data.type == 'user_left') {
        ...
        if (userIdInDisplayFrame == `user-container-${data.uid}`) {
            displayFrames.style.display = 'none'
...
let addMessageToDom = (name, message) => {
    ...
    <div class="message__body">
        ...
        <p class="message__text">${message}</p></div></div>`
...
let addBotMessageToDom = (botMessage) => {
    ...
    <div class="message__body__bot">
        <strong class="message__author__bot">🤖 Agora Chat Bot</strong>
